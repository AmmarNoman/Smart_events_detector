...
def get_data_for_interval(data, start_indx, end_indx, event_type, event_dir):
    ...
    result[GEO_KEY]['spd'] = interpolate_array(result[GEO_KEY]['spd'], num_elements_speed)\
                           + interpolate_array(result[GEO_KEY]['spd'], 5)
...
def Prepaire(inputfile, eventsfile, outputfile, time_delta_events_msec=TIME_DELTA_EVENTS, NUM_EL_GYR_ACC=100, NUM_EL_SPEED=10, NUM_EL_TIME=1):
    ...
    #print "\nnum_elements_speed =  ",num_elements_speed
